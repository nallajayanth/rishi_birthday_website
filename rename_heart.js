...
if (imageFiles.length === 0) {
  console.log('No images found in my_heart.');
  process.exit(0);
}
...
console.log('Renaming files sequentially to heart_X.jpeg...');

imageFiles.forEach((oldName, index) => {
  const newName = `heart_${index + 1}.jpeg`;
...
console.log('My Heart renaming completed successfully!');
